...
public class ScreenDrawer {
    ...
    protected void drawGameScreen() {
        ...
        engine.mapGen = new World(engine.SEED);
    ...
    public void renderFinishScreen(boolean wonGame, int stepsTaken) {
        if (wonGame) {
            drawWinningScreen(World.getWidth(), World.getHeight(), stepsTaken);
        } else {
            drawLosingScreen(World.getWidth(), World.getHeight(), stepsTaken);
        }
    }
